...
Use the bundled script from this Claude Code project skill:

```bash
python .claude/skills/mathkg-process/scripts/mathkg_agent_tool.py <subcommand> <input.md> [pipeline options]
```
