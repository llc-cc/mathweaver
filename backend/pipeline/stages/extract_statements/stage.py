    ...
    def clean_block_text(block):
        ...
        for field in ("content", "proof"):
            ...
            if isinstance(value, str):
                # Values have already crossed the JSON/parser boundary.  Keep
                # both TeX row separators (``\\``) and line boundaries intact:
                # later stages use these strings for source spans and display.
                cleaned_block[field] = value
